...
CREATE TABLE `speedtest` (
  ...
  `latency` float(53) DEFAULT NULL COMMENT 'latency in milliseconds',
  `download` float(53) DEFAULT NULL COMMENT 'download speed in mbps',
  `upload` float(53) DEFAULT NULL COMMENT 'upload speed in mbps',
  `server` varchar(200) DEFAULT NULL COMMENT 'server used for testing',
